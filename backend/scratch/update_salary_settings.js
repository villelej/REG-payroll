...
fs.writeFileSync('d:/payroll/payroll-ui-refactor/app/salary-settings/page.tsx', content, 'utf8');
console.log('Salary settings successfully updated to remove deductions.');
